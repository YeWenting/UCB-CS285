...
class ReplayBuffer(object):
    ...
    def sample_random_data(self, batch_size):
        ...
        new_idxes = np.random.permutation(self.obs.shape[0])
        ...
        return self.obs[new_idxes][-batch_size:], self.acs[new_idxes][-batch_size:], self.rews[new_idxes][-batch_size:], self.next_obs[new_idxes][-batch_size:], self.terminals[new_idxes][-batch_size:]
